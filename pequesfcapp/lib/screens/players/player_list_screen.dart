    ...
    return guardiansAsync.when(
      ...
      data: (guardians) {
        return categoriasAsync.when(
          ...
          error: (e, _) => Center(child: Text('Error: $e')),
          data: (categoriasBD) {
            // Ordena las categorías de menor a mayor
            final categoriasOrdenadas = [...categoriasBD]
              ..sort((a, b) => a.categoria.compareTo(b.categoria));

            final categoriasDropdown = categoriasOrdenadas
              ...
              data: (jugadores) {
                final jugadoresFiltrados = jugadores.where((jugador) {
                  final coincideCategoria = categoriaSeleccionada == null ||
                      jugador.categoriaEquipoId == categoriaSeleccionada;
                      ...
                      child: jugadoresFiltrados.isEmpty
                          ...
                          : ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                // Busca la categoría real en la BD
                                final categoriaEquipo = categoriasOrdenadas.firstWhere(
                                  (cat) => cat.id == jugador.categoriaEquipoId,
                                ...
                                return Card(
                                  ...
                                  child: ListTile(
                                    ...
                                    subtitle: Text(
                                      'Categoría: ${categoriaEquipo.categoria} - ${categoriaEquipo.equipo}\nApoderado: $nombreApoderado',
