...
class PagosHijoScreen extends StatelessWidget {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return Card(
          ...
          child: ListTile(
            leading: const Icon(Icons.attach_money, color: Color(0xFFD32F2F)),
            ...
            trailing: ElevatedButton(
              ...
              onPressed: () {
                // Navega al historial de pagos del hijo
                // Navigator.push(context, MaterialPageRoute(builder: (_) => PaymentHistoryScreen(jugadorId: hijo.id, jugadorNombre: '${hijo.nombres} ${hijo.apellido}')));
              },
            ),
          ),
        );
