              ...
              return ListView.builder(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) => ProfesorDetailScreen(profesorId: profesor.id),
                    ),
                  );
                },
                onLongPress: () {
                          ...
                          ListTile(
                            ...
                            onTap: () {
                              ...
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (_) => ProfesorFormScreen(profesor: profesor),
                                ),
                              );
                            },
                          ),
                            ...
                            onTap: () async {
                              ...
                              final confirm = await showDialog<bool>(
                                ...
                                builder: (context) => AlertDialog(
                                  ...
                                  content: const Text('¿Estás seguro de eliminar este profesor?'),
                                  actions: [
                                    TextButton(
                              ...
                              if (confirm == true) {
                                await ref.read(profesorRepositoryProvider).deleteProfesor(profesor.id);
                                ref.invalidate(profesoresProvider);
                                if (context.mounted) {
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    const SnackBar(content: Text('Profesor eliminado correctamente')),
                                  );
                                }
                              }
                            },
                ...
                child: Card(
                  ...
                  child: ListTile(
                    ...
                    title: Text('${profesor.nombre} ${profesor.apellido}', style: const TextStyle(fontWeight: FontWeight.bold)),
                    subtitle: Column(
